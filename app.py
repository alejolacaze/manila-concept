...
with app.app_context():
    ...
    if Producto.query.count() == 0:
        productos_iniciales = [
            ...
            Producto(nombre="Remera Oversize - Summer 2025", precio=45000, imagen="remera.jpeg", descripcion="Remera de corte oversize pensada para un outfit relajado y actual. Confeccionada en algodón 20.1 premium de tacto suave, con una combinación de estampas DTG y detalles bordados."),
