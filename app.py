...
with app.app_context():
    ...
    if Producto.query.count() == 0:
        productos_iniciales = [
            Producto(nombre="Remera Boxy - Staff Members", precio=47500, imagen="boxy.jpeg", descripcion="Remera corte boxy fit de actitud street, con calce amplio y caida pesada. Confeccionada en algodon premium, pensada para bancarse el uso diario.", talles="S,M,L,XL"),
            Producto(nombre="Short - Logo Bear", precio=38000, imagen="short.jpeg", descripcion="Short de diseño minimalista, confeccionado en tejido suave y resistente, ideal para uso diario y tiempo libre.", talles="S,M,L,XL"),
            Producto(nombre="Remera Oversize - Summer 2025", precio=45000, imagen="remera.jpeg", descripcion="Remera de corte oversize pensada para un outfit relajado y actual.", talles="S,M,L,XL"),
            Producto(nombre="Musculosa Oversize - My Mum Says", precio=36000, imagen="musculosa.jpeg", descripcion="Musculosa de corte relajado confeccionada en algodón suave 20.1 premium.", talles="S,M,L,XL"),
        ]
